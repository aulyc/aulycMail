...
export function ClearActivityLogs(arg1:activitylog.Query):Promise<number>;
...
export function GetAutomaticUpdateChecks():Promise<boolean>;
...
export function GetLatestActivityLog(arg1:string,arg2:string):Promise<activitylog.Entry>;
...
export function InstallAvailableUpdate():Promise<updater.Status>;
...
export function ListActivityLogs(arg1:activitylog.Query):Promise<activitylog.Page>;
...
export function SetAutomaticUpdateChecks(arg1:boolean):Promise<void>;
