...
Portions of this software may include code or materials originally distributed
under the Apache License, Version 2.0 and modified by aulyc. Those portions
remain subject to the Apache-2.0 terms below.
   ...
   1. Definitions.
      ...
      means any form of electronic, verbal, written communication sent
...
Version 1.1. The source-tree copy is available at:

    frontend/src/assets/fonts/OFL.txt

When packaged, this notice is copied into the application bundle under:

    Contents/Resources/Legal/Nunito-OFL.txt
...
Those components remain governed by their respective upstream licenses.
