// Package calendar is the top-level Go package for the Calendar extension.
...
//
// The real backend implementation lives in extensions/calendar/backend; the
// frontend assets in extensions/calendar/frontend.
package calendar
...
func Manifest() coreapi.Manifest {
	...
	if err := json.Unmarshal(manifestJSON, &m); err != nil {
		panic("calendar: manifest.json is malformed (build-time bug): " + err.Error())
	}
	return m
}
