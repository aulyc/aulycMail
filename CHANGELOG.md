...
- 备份邮箱的“全部邮箱”支持再次点击后全部反选，部分选择时仍可一键全选。
- 备份导出等待当前批次时显示闪动的“工作中…”状态，避免进度暂时停在 0% 时被误认为卡死。
...
## [0.7.5-beta.2] — 2026-08-06

- 将设置页帮助提示改为一体式气泡，让箭头、边框、背景和阴影呈现为连续的整体轮廓。
- 将设置页的“系统更新”统一为“软件更新”，并把检查状态呈现为独立按钮，避免整行产生可点击的误导。
- 扩充邮件操作、同步、更新器和关键界面交互测试，并提高前后端覆盖率防回退门槛。
